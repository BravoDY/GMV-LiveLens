...
function updateSummaryCardLayout() {
  ...
  const minTotalSingleLineWidth = 250;
  ...
  const singleLineUnitWidth = (width - ((singleLineColumns - 1) * gap)) / singleLineColumns;
  const canSingleLine = singleLineUnitWidth >= Math.max(minSingleLineWidth, minTotalSingleLineWidth);
