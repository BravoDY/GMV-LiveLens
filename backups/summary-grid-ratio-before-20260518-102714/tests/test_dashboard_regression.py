...
def test_dashboard_mobile_responsive_rules_hide_time_and_prevent_overflow() -> None:
    ...
    assert "grid-template-columns: minmax(420px, 2.05fr) minmax(0, 5fr);" in styles_content
    assert "grid-template-columns: repeat(auto-fit, minmax(188px, 1fr));" in styles_content
    ...
    assert "20260518-platform-adaptive-0001" in official_content
    assert "20260518-platform-adaptive-0001" in test_content
