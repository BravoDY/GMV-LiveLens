...
;// CONCATENATED MODULE: ./content-scripts/lib/dumpscript.js
...
``
    ...
    const dumpNavigatorProps = async () => {
        return dumpObjProps(navigator, [
            ...
            'storage', 'requestMediaKeySystemAccess', 'bluetooth', 'language', 'systemLanguage', 'userLanguage', 'mimeTypes',
        ]);
    };
...
;// CONCATENATED MODULE: ./content-scripts/dump.content-script.ts
...
var gatherFingerprint = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = JSON).parse;
                return [4 /*yield*/, dumpScript()];
            case 1:
                data = _b.apply(_a, [_c.sent()]);
                chrome.runtime.sendMessage({ type: 'fingerprintDataCollected', data: data });
                return [2 /*return*/];
        }
    });
}); };
