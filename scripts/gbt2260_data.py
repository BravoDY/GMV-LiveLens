"""
完整 GB/T 2260 中国行政区划代码(地级市/自治州/地区/盟级别,6位编码)
仅收录到地级,末两位为00
"""
GB_T2260_CITY = {
    # 北京市 110000
    ...
    "通辽市": "150500", "鄂尔多斯市": "150600", "呼伦贝尔市": "150700",
    "巴彦淖尔市": "150800", "乌兰察布市": "150900",
    ...
    "五指山市": "469001", "琼海市": "469002", "文昌市": "469005", "万宁市": "469006",
    "东方市": "469007", "定安县": "469021", "屯昌县": "469022", "澄迈县": "469023",
    "临高县": "469024", "白沙黎族自治县": "469025", "昌江黎族自治县": "469026",
    "乐东黎族自治县": "469027", "陵水黎族自治县": "469028",
    "保亭黎族苗族自治县": "469029", "琼中黎族苗族自治县": "469030",
    # 重庆市 500000
    "重庆市": "500100",
    # 四川省 510000
    ...
    "山南市": "540500", "那曲市": "540600", "阿里地区": "542500",
    # 陕西省 610000
    ...
    "和田地区": "653200", "伊犁哈萨克自治州": "654000", "塔城地区": "654200",
    "阿勒泰地区": "654300",
    # 新疆兵团城市(自治区直辖)
    "石河子市": "659001", "阿拉尔市": "659002", "图木舒克市": "659003",
    "五家渠市": "659004", "北屯市": "659005", "铁门关市": "659006",
    "双河市": "659007", "可克达拉市": "659008", "昆玉市": "659009",
    "胡杨河市": "659010", "新星市": "659011",
    # 台湾
    "台北市": "710100",
    # 香港
    "香港岛": "810100", "九龙": "810200", "新界": "810300",
    # 澳门
    "澳门半岛": "820100", "离岛": "820200",
}

# 简称/别名映射 (M列里常见的简写 → 标准全称)
ALIAS_MAP = {
    "吐鲁番地区": "吐鲁番市",
    "哈密地区": "哈密市",
    "日喀则地区": "日喀则市",
    ...
    "白沙县": "白沙黎族自治县",
    "昌江县": "昌江黎族自治县",
    # 怒江州在C列中是怒江傈僳族自治州(533300)
    "怒江州": "怒江傈僳族自治州",
}

SPECIAL_REASONS = {
    "中国香港": "香港在C列分香港岛(810100)/九龙(810200)/新界(810300),无法确定",
    "中国澳门": "澳门在C列分澳门半岛(820100)/离岛(820200),无法确定",
    "雄安新区": "雄安新区尚无独立GB/T 2260编码",
    "台湾": "台湾编码710000,不在C列中",
    "加拿大": "国外地址",
    "日本": "国外地址",
    "美国": "国外地址",
